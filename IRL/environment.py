...
class GridWorldEnv(discrete.DiscreteEnv): 
    ...
    def __init__(self, grid, move_prob=0.8, default_reward=0.0): 
        # grid is 2d-array, and each value is treated as attribute. 
        # attribute is 
        #   0: ordinaly cell
        ...
        # Make transitions 
        P = {} # 迷路の形をした行列で，各マス目には遷移確率や報酬の情報が入っている
    ...
    def state_to_coordinate(self, s): 
        row, col = divmod(s, self.nrow) # 商と余りを返す
        return row, col
    ...
    def _move(self, state, action):
        ...
        # Detection of overrunning the grid 
